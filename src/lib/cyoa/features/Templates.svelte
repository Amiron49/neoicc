<script lang="ts">
	...
	] satisfies App['styling'][];

	function changeStyling(templateIdx: number) {
		console.log(app.styling);
		app.styling = styleTemplates[templateIdx];
	}
</script>
...
<Dialog.Root bind:open={() => open, (a) => !a && onclose()}>
	<Dialog.Content class="max-h-screen overflow-y-auto sm:max-w-[1200px]">
		<Dialog.Header>
			<Dialog.Title>Style Templates</Dialog.Title>
		</Dialog.Header>
		<div class="grid gap-4 py-4">
			<h6>More will be added later.</h6>
			<div class="grid grid-cols-4 gap-2">
				<Button onclick={() => changeStyling(0)}>Fall</Button>
				<Button onclick={() => changeStyling(1)}>Book</Button>
				<Button onclick={() => changeStyling(2)}>Bone</Button>
				<Button onclick={() => changeStyling(3)}>Dark</Button>
				<Button onclick={() => changeStyling(4)}>Hello 2021</Button>
				<Button onclick={() => changeStyling(5)}>Black and Gold</Button>
				<Button onclick={() => changeStyling(6)}>Rainbow</Button>
				<Button onclick={() => changeStyling(7)}>Seeing Greens</Button>
			</div>
		</div>
		<Dialog.Footer>
